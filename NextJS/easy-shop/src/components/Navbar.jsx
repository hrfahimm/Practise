...
const Navbar = () => {
    ...
    return (
        <nav className='navbar sticky mt-4 rounded-xl top-0 z-10 bg-slate-200 shadow-lg dark:bg-slate-900 lg:pr-3'>
            <div className='flex-1'>
                <Link
                    href='/'
                    className='btn-ghost btn text-2xl normal-case font-extrabold italic '>
                    Easy Shop
                </Link>
            </div>
            <div
